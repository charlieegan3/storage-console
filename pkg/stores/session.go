...
type SessionStore interface {
	GetSession(sessionID string) (*webauthn.SessionData, bool, error)
	DeleteSession(sessionID string) error
	StartSession(data *webauthn.SessionData) (string, error)
	AuthenticateSession(sessionID string) error
}
